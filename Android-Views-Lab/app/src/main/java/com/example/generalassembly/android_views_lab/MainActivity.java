...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonTen = (Button) findViewById(R.id. ten);
...
//            }
        ...
        mButtonThree.setOnClickListener(name);
        mButtonFour.setOnClickListener(name);
        mButtonFive.setOnClickListener(name);
        mButtonSix.setOnClickListener(name);
        mButtonSeven.setOnClickListener(name);
        mButtonEight.setOnClickListener(name);
        mButtonNine.setOnClickListener(name);
        mButtonTen.setOnClickListener(name);
    }
}
